...
{
    public class Withdraw(ILogger<Withdraw> logger, 
        IAccountRepository accountRepository, 
        IEventBus eventBus)
        : ICommand<WithdrawRequest, AccountResponse>
    {
        public async Task<AccountResponse> ExecuteAsync(WithdrawRequest request, CancellationToken token)
        {
